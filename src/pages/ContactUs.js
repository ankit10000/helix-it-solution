      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <form className="space-y-4">
            ...
            <button type="submit" className="w-full bg-orange-500 text-white px-4 py-2 rounded-lg font-semibold hover:bg-orange-600 transition">
              Send Message
            </button>
          </form>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700">123 Business Street, Jaipur, India</p>
            <p className="text-gray-700">Email: solutionhelixit@gmail.com</p>
            <p className="text-gray-700">Phone: 7296911651, 7737063697, 6375722866, 9636394444</p>
          </div>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            <iframe 
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3561.563067746761!2d75.7872701749506!3d26.84669336477081!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db5da127cbbcb%3A0x77dc3eaa6b4a3c42!2sJaipur%2C%20Rajasthan%2C%20India!5e0!3m2!1sen!2sin!4v1649748203095!5m2!1sen!2sin" 
              allowFullScreen="" 
              loading="lazy">
            </iframe>
          </div>
