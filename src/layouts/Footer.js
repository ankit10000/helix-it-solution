                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 mt-4">
                            <a href="https://www.facebook.com/profile.php?id=61568130518127" className="bg-gray-700 p-2 rounded-full hover:bg-blue-500 transition">
...
" className="bg-gray-700 p-2 rounded-full hover:bg-blue-500 transition">
                            ...
                            <a href="https://www.instagram.com/helix_it_solution?igsh=NTZpdHdobGozcnJ5" className="bg-gray-700 p-2 rounded-full hover:bg-blue-500 transition">
